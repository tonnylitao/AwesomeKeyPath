//
//  KPInfixOperatorMultiplication.swift
//  AwesomeKeyPath
//
...
extension KeyPath where Value: Numeric {
    
    public static func * (_ lhs: KeyPath, _ rhs: Value) -> (Root) -> Value {
        { $0[keyPath: lhs] * rhs }
    }
    
    public static func * (_ lhs: Value, _ rhs: KeyPath) -> (Root) -> Value {
        { lhs * $0[keyPath: rhs] }
    }
...
extension KeyPath where Value: FloatingPoint {
